...
exports.SnapshotGroupsClient = void 0;
 ...
 */
const gapicConfig = require("./snapshot_groups_client_config.json");
...
class SnapshotGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.compute.v1beta.SnapshotGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.snapshotGroupsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.compute.v1beta.SnapshotGroups') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.compute.v1beta.SnapshotGroups, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const snapshotGroupsStubMethods = ['delete', 'get', 'getIamPolicy', 'insert', 'list', 'setIamPolicy', 'testIamPermissions'];
        for (const methodName of snapshotGroupsStubMethods) {
            const callPromise = this.snapshotGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.SnapshotGroupsClient = SnapshotGroupsClient;
//# sourceMappingURL=snapshot_groups_client.js.map